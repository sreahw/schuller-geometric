...
\bse
\begin{tikzcd}
M \ar[rr,"\phi"] \ar[ddrr,"g\circ\phi"'] && N \ar[dd,"g"] && C^\infty(M) \ar[dd,"X"] && C^\infty(N) \ar[ll,"-\circ\phi"']\ar[ddll,"\d_p\phi\,(X)"]\\
&& && &&\\
&& \R && \R&&
\end{tikzcd}
\ese
...
\bse
\begin{tikzcd}
C^\infty(M) \ar[dd,"X"] && C^\infty(N) \ar[ll,"-\circ\phi"']\ar[ddll,"(\phi_*)_p(X)"]   && T_pM \ar[rr,"(\phi_*)_p"] \ar[ddrr,"(\phi^*)_p(\omega)"'] && T_{\phi(p)}N \ar[dd,"\omega"]\\
&& && &&\\
\R&& && && \R
\end{tikzcd}
\ese
...
\bse
\begin{tikzcd}
C^\infty(M) \ar[rr,"-\circ\phi^{-1}"] \ar[ddrr,"(\phi^*)_p(Y)"'] && C^\infty(N) \ar[dd,"Y"]    && T_pM \ar[dd,"\eta"']   && T_{\phi(p)}N \ar[ll,"((\phi^{-1})_*)_{\phi(p)}"'] \ar[ddll,"(\phi_*)_p(\eta)"] \\
&& && &&\\
&& \R && \R && 
\end{tikzcd}
\ese
...
\bd
A smooth map $\phi\cl M \to N$ is said to be an \emph{embedding}\index{embedding} of $M$ into $N$ if
\begin{itemize}
...
\bd
Let $M$ be a $d$-dimensional manifold. The \emph{tangent bundle}\index{tangent bundle} of $M$ is the $2d$-dimensional manifold $TM$, equipped with the smooth projection map $\pi\cl TM \to M$.
\ed
