...
\een
The pair $(M,\cO)$ is called a \emph{topological space}.
\ed
...
\bse
\R^d:=\underbrace{\R\times\R\times\ldots\times\R}_\text{$d$ times}.
\ese
...
\bse
U \in \cO_{A_1\times \ldots \times A_n} :\eqv \forall \, p \in U : \exists \, (S_1,\ldots,S_n) \in \cO_{A_1}\times \ldots \times \cO_{A_n} : S_1\times \ldots\times S_n \se U.
\ese
\er
...
\bse
\cO_\mathrm{std} = \cO_{\underbrace{\scriptstyle \R\times\R\times\ldots\times\R}_\text{ $d$ times}}.
\ese
...
\br
Unlike for sets, there isn't yet a classification of topological spaces. That is, nobody has been able to determine a set of properties such that if two topological spaces agree on this set of properties, then they are homeomorphic.
\er
