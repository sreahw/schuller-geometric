...
\draw [-stealth] plot[smooth, tension=.7] coordinates {(1.1834,-0.5006) (2.2576,0.2354) (2.5265,1.5914) (2.3316,2.0564)};
\draw [-stealth] plot[smooth, tension=.7] coordinates {(1.8399,2.3042) (0.7458,1.7472) (0.3281,0.872) (0.7259,-0.1226)};
...
The \emph{components functions} of $x\cl U\to \R^d$ are the maps:
\bi{rcCl}
x^i \cl & U  & \to & \R\\
& p & \mapsto & \mathrm{proj}_i(x(p))
\ei
...
\bd
A \emph{$C^0$-atlas}\index{atlas}\index{atlas!$C^0$} of a manifold is an atlas of pairwise $C^0$-compatible charts.
\ed

Note that any atlas is also a \emph{$C^0$-atlas}.

\bd
A $C^0$-atlas $\mathscr{A}$ is said to be a \emph{maximal atlas}\index{atlas!maximal} if for every $(U,x)\in\mathscr{A}$, we have $(V,y)\in\mathscr{A}$ for all $(V,y)$ charts that are $C^0$-compatible with $(U,x)$.
\ed
